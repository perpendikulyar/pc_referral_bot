...
Набрав достаточное количество реферралов, ты можешь получить плюшки от организаторов и даже приглашение посетить кэмп офлайн`,
...
Команда ProductCamp`,
    ...
    genKeyboard: `✨ Мы подготовили шаблоны для сторис и сгенерили классные тексты для приглашений, ты можешь забрать их ниже.\n ⬛ Или сгенери QR-код и используй его для привлечения даже в офлайне!`,
