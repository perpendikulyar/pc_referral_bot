...
const localeRU: Locale = {
    welcome: `Привет! \n 
Реферальной программа осеннего ProductCamp 2025 завершена, и мы уже подвели итоги, посмотри их по кнопке ниже!\n
Участвуй в следующий раз и получи шанс стать амбассадором ProductCamp и внеси свой ценный вклад в развитие продуктового сообщества!`,
...
Команда ProductCamp`,
    ...
    genKeyboard: `✨Создай свою аватарку кэмпа в этом боте, забери шаблоны постов для каналов и соцсетей, сгенерируй приглашение или сделай свой QR-код и делись им в офлайне.\n`,
    ...
    results: `*Финальные результаты реферальной программы ProductCamp Autumn 2025*\n
