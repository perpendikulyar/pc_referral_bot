...
❗️ Во-первых, для успеха тебе нужно *минимум 30 баллов* для попадания в лидерборд. За участников, которые регистрируются на офлайн-формат начисляется 3 балла, за онлайн — 1 балл.\nЭто могут быть продакт-менеджеры, аналитики, продукт-маркетинг менеджеры, UX- и продуктовые дизайнеры, проджект-менеджеры, CPO, CEO и все, чья жизнь связана с разработкой продуктов.\n
...
Команда ProductCamp`,
    ...
    genKeyboard: `✨Скоро все появится!\n А пока, создай фирменную аватарку, сгенерируй приглашение или сделай свой QR-код и делись им в офлайне.\n`,
