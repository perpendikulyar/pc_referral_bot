...
Вместе мы смогли пригласить более 10% участников кэмпа — что значит каждый участник программы внес свой неоценимый вклад в создание кэмпа, пригласив друзей и колег. Большое спасибо всем и каждому, вы большие молодцы! 🫶🫶🫶\n
До встречи на кэмпе!
А также хотим напомнить про Летний ProductCamp, и новая реферальная программа запустится уже совсем скоро. И ходят слухи, что там вас ждет кое-что интересное...
`,
};
