...
Пригласи на ProductCamp своих коллег и друзей, мы уверены среди них будет много заинтересованных 🙏`,
    generatorExplainMore: `😎 *Вот несколько классынх рекомендаций, чтобы все получилось:*\n
...
👩‍🎤 У тебя наверняка есть есть чатики продактов, маркетологов, дизайнеров и других диджитал-профессионалов — закинь ссылку туда, им точно будет интересно. Можешь отправить даже в чат Кэмпа 😜\n
...
🫶 А еще мы сделали генератор инвайтов — воспользуйся им, и получишь прикольный текст приглашения 💅`,
    generatorMoreBtn: '🤔 Как не облажаться и привести много реферралов?',
...
[Связать с нами](https://docs.google.com/forms/d/1Gg2XqR_-m-BjdYYmbXu1mQyBhiGuYi7fG3iPzkpKoak/viewform?edit_requested=true)\n
С любовью ❤️‍🔥,
Команда ProductCamp`,
