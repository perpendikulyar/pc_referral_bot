...
Команда ProductCamp`,
    ...
    genKeyboard: `✨ Пока доступна только возможность сгенерить сой QR-код, но совсем скоро появится возможность сделать аватар кэмпа, сгенерировать приглошение или получить шаблоны для рилсов!`,
