...
Уже на этот кэмп ты можешь поехать Амбассадором, если по твоей ссылке зарегистрируется много классных участников, и ты наберешь достаточное количество баллов`,
...
Команда ProductCamp`,
    ...
    storiesHelp: 'Лови! Ты отлично справляешься!\n\nНе забудь добавить свою ссылку 🤓',
    genKeyboard: `✨Сгенери свою аватарку кэмпа в этом боте, забери шаблоны постов для каналов и соцсетей или сделай свой QR-код и делись им в офлайне.\n А совсем скоро появится возможность сгенерировать приглашение!`,
